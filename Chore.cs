...
namespace ChoreSpace
{
    public class Chore
    {
        ...
        //constructor
        public Chore(string name, int passedUserId, string deadline, bool willRecur, int daysUntilRecur)
        {
            isCompleted = false;
            completedUserId = -1;
            ...
            isRecurring = willRecur;
            recurRate = daysUntilRecur;
        }
